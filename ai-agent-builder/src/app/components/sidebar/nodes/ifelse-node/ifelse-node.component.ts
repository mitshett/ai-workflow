...
@Component({
  ...
  templateUrl: './ifelse-node.component.html',
  styleUrl: './ifelse-node.component.scss'
})
export class IfElseNodeComponent {
  
  // Node properties
  readonly nodeType: NodeType = 'if-else';
  readonly iconName = 'flow-arrow';
  readonly label = 'If / else';
  ...
  onDragStart(event: any): void {
    console.log('If/else node drag started');
  ...
  onDragEnd(event: any): void {
    console.log('If/else node drag ended');
